...
**
** Created: Thu Nov 25 15:43:34 2010
...
static const char qt_meta_stringdata_Population[] = {
    "Population\0\0getResponse()\0"
};

const QMetaObject Population::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Population,
      qt_meta_data_Population, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Population::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Population))
