...
**
** Created: Thu Nov 25 15:43:41 2010
...
static const char qt_meta_stringdata_Easter[] = {
    "Easter\0\0getResponse(QtSoapMessage)\0"
};

const QMetaObject Easter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Easter,
      qt_meta_data_Easter, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Easter::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Easter))
...
int Easter::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: getResponse((*reinterpret_cast< const QtSoapMessage(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
